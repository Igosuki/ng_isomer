	...
	function init(params) {
		...
		*/
		grunt.initConfig({
			...
			scssDirPathRoot:    cfgJson.scss.dirPathRootPrefix+staticPath,
			...
			buildfiles: {
				...
				configPaths: {
					...
					//@todo - _base.scss file paths (have a prefix path relative to this file for @import)
					scssFilePaths:{
						prefix: '../../',
			...
			*/
			watch: {
				...
				//compile scss if a scss file changes
					scss: {
						files: [],		//will be filled by grunt-buildfiles
						// tasks: ['compass:dev']
						tasks: ['q-watch']
			...
			*/
			...
			fontAwesomeVars: {
				main: {
					variablesScssPath: publicPathRelativeRoot+'bower_components/font-awesome/scss/_variables.scss',
